      ...
      <div className="flex w-full flex-col items-center pt-[69px]">
        <div className="w-full px-3 lg:max-w-[978px]">
          ...
          <div className="mb-[86.98px] flex justify-center">
            <div className="flex h-full w-full max-w-5xl justify-center rounded-[20px] bg-[rgba(255,255,255,0.20)] px-2 py-10 shadow-[0_4px_20px_0_rgba(39,55,125,0.10)] backdrop-blur-[10px] lg:h-[196px] lg:px-32 lg:py-14">
