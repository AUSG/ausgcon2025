...
- 1년간 수많은 성장을 동반했던 저의 성장 가속에 대한 비결을 공유하려 합니다.`,
        category: [{ name: "경험", color: "#F3DA89" }],
        speaker: {
          name: "장영하",
          team: "Artify",
          picture: "/image/speaker_장영하.jpg",
        },
      },
      {
        time: "16:40 - 17:10",
...
- ‘커뮤니티’가 이런 고민을 듣고 나의 역량을 키워주는 좋은 기회가 될수 있는지, 그리고 춘식이처럼 집에만 있는 개발자가 아니라 어피치처럼 매력적인 개발자로 성장할 수 있는 방법에 대해 이야기 해보고자 합니다.`,
        ...
        speaker: {
          name: "김대현",
          team: "카카오스타일",
          picture: "/image/speaker_김대현.jpeg",
        },
      },
      {
        time: "17:20 - 18:00",
  ...
  },
  {
    ...
    sessionList: [
      ...
      },
      {
        time: "14:30 - 15:00",
        sequence: "1ST SESSION",
        name: "내가 성장 할 수 있던 시온식 사고",
        description: `개발 뭐 어려운거 있어? (어려움)
뭐든 할 수 있다고 생각하고 덤비는 시온식 사고로 성장하기`,
        category: [{ name: "커리어", color: "#94F389" }],
        speaker: {
          name: "강시온",
          team: "Lablup Inc.",
          picture: "/image/speaker_강시온.jpeg",
        },
      },
      {
        time: "15:10 - 15:40",
...
- 취준생, 그리고 취업 이후에도 항상 괴롭히던 이 느낌을 어떻게 컨트롤 하면 좋을지, 제가 후회하던 경험과 더불어 이야기하고자 합니다.`,
        ...
        speaker: {
          name: "안지완",
          team: "몰로코",
          picture: "/image/speaker_안지완.jpeg",
        },
      },
      {
        time: "15:10 - 15:40",
...
- 성장은 ‘필요에 의한 공부’에서 오며, 프로덕션의 실제 문제(안정성·자동화·관측)를 풀 때 배움이 가장 빠르게 쌓인다는 점을 강조합니다.`,
        ...
        speaker: {
          name: "최용환",
          team: "당근",
          picture: "/image/speaker_최용환.jpeg",
        },
      },
      {
        time: "16:00 - 16:30",
...
이번 발표에서는 테스트의 본질과 테스트 코드 방법론까지 알아보고, 한발 더 나아가 단순히 코더가 아닌 엔지니어로서 커리어를 레벨업하는 방법에 대해 함께 나눠보려고 합니다.`,
        ...
        speaker: {
          name: "김한수",
          team: "뱅크샐러드",
          picture: "/image/speaker_김한수.jpeg",
        },
      },
      {
        time: "17:20 - 18:00",
